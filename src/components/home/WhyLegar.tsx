...
const USPS = [
  ...
  },
  {
    ...
    description:
      "Затримали о 3-й ночі? Гаряча лінія 0 800 357 288 працює цілодобово. Виїзд адвоката на ТЦК — 8 000 грн, на затримання поліцією — 10 000 грн. Ціни фіксовані. Жодних «договорим на місці».",
  },
];
