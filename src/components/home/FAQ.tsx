...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Так. Гаряча лінія 0 800 357 288 працює цілодобово, без вихідних. Нічна консультація (22:00–08:00) коштує 1 500 грн / 20 хвилин. Виїзд адвоката на ТЦК у будь-який час — 8 000 грн. Виїзд на затримання поліцією — 10 000 грн. Повний пакет SOS 24/7 з пріоритетним реагуванням — 24 000 грн на місяць.",
  },
  {
