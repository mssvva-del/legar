...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Телефонуєте або пишете — адвокат відповідає до 30 хвилин (цілодобово). Для виїзду — адвокат прибуває на місце (ТЦК, КПП, місце затримання) у межах міста. Тарифи: нічний дзвінок від 800 грн, виїзд від 7 500 грн.",
  },
  // PRICES
  {
    cat: "prices",
