...
const SOS_PACKAGES = [
  { name: "Нічний дзвінок", desc: "Телефонна консультація 20 хв вночі (22:00–08:00)", price: "800 грн" },
  { name: "Виїзд у ТЦК", desc: "Виїзд адвоката на виклик у ТЦК / КПП / фільтраційний пункт", price: "7 500 грн" },
...
const COMPARISON = [
  ...
  { item: "Антиштраф ТЦК", legar: "від 8 500 грн", market: "15 000–40 000 грн", save: "до 70%" },
  { item: "ВЛК Pro", legar: "від 14 000 грн", market: "25 000–60 000 грн", save: "до 75%" },
  { item: "Захист по СЗЧ", legar: "від 28 000 грн", market: "50 000–120 000 грн", save: "до 75%" },
  { item: "SOS виклик", legar: "від 800 грн", market: "2 500–6 000 грн", save: "до 85%" },
  { item: "B2B пакет / 10 осіб", legar: "від 65 000 грн", market: "130 000–200 000 грн", save: "до 65%" },
];
