...
export const metadata: Metadata = {
  title: "Отримали повістку? Дізнайтесь свої права з адвокатом | LEGAR",
  description:
    "Повістка — це не вирок і не мобілізація. Адвокати НААУ пояснять ваші права, строки та законні дії. Супровід у ТЦК від 5 000 грн.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "Отримали повістку? Дізнайтесь свої права",
    description: "Консультація адвоката НААУ — 490 грн. Знай свої права.",
...
const TRUST_ITEMS = [
  ...
  { icon: Shield, label: "Консультація 490 грн", sub: "зараховується у вартість послуги" },
...
const HOW_IT_WORKS = [
  ...
  { n: "2", title: "Адвокат телефонує", desc: "Пояснює ваші права, строки та законні варіанти дій." },
...
const FAQS = [
  {
    ...
    a: "Ні. Повістки бувають різні: уточнення даних, проходження ВЛК, призов. Кожна має свої правила і строки. Адвокат пояснить, що означає саме ваша.",
  },
  {
  ...
  },
  {
    ...
    a: "Консультація — 490 грн (зараховується у вартість послуги): права, строки, план дій. Платні послуги (супровід, документи) — тільки якщо вони вам реально потрібні, з фіксованою ціною в договорі.",
  },
];
          ...
          <div className="grid items-start gap-12 lg:grid-cols-[1fr_420px]">
            <div className="pt-2">
              ...
              <p className="mt-5 text-[17px] leading-relaxed text-white/70 md:text-[19px]">
                Перші дії вирішують. Адвокати НААУ пояснять, що
            ...
            <div className="w-full">
              <LandingLeadForm
                formId="hero"
                ctaLabel="Отримати консультацію — 490 грн"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_420px]">
            <div>
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-[var(--color-ink)]/75">
                Заповніть форму — адвокат зателефонує і пояснить
