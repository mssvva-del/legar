...
export const metadata: Metadata = {
  title: "Оскаржити висновок ВЛК — безкоштовна перевірка адвокатом | LEGAR",
  description:
    "Не згодні з висновком ВЛК? Адвокати НААУ безкоштовно перевірять висновок і скажуть шанси на оскарження. ВЛК Pro від 14 000 грн під ключ.",
  robots: { index: false, follow: false },
  openGraph: {
    title: "Оскаржити висновок ВЛК — безкоштовна перевірка",
...
const HOW_IT_WORKS = [
  ...
  { n: "2", title: "Адвокат перевіряє висновок", desc: "Безкоштовно аналізує висновок ВЛК і медичні документи." },
...
const FAQS = [
  {
    ...
    a: "«ВЛК Pro» — від 14 000 грн під ключ: аналіз висновку, допомога зі збором медичних документів, скарга до апеляційної ВЛК, за потреби — суд. Спочатку безкоштовна перевірка висновку, потім — рішення.",
  },
  {
          ...
          <div className="grid items-start gap-12 lg:grid-cols-[1fr_420px]">
            <div className="pt-2">
              ...
              <p className="mt-5 text-[17px] leading-relaxed text-white/70 md:text-[19px]">
                Адвокати НААУ безкоштовно перевіряють висновок ВЛК і медичні
            ...
            <div className="w-full">
              <LandingLeadForm
                formId="hero"
                ctaLabel="Безкоштовна перевірка висновку"
                service="vlk-pro"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1fr_420px]">
            <div>
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-[var(--color-ink)]/75">
                Заповніть форму — адвокат зателефонує і безкоштовно скаже, чи є
