...
const ANGLES: Record<ServiceSlug, ServiceCityAngle> = {
  ...
  "antyshtraf-tck-360": {
    ...
    faqAnswer: (city) =>
      `Послуга «Антиштраф ТЦК 360°» стартує від 8 500 грн і включає повний цикл оскарження ${city.nameInflected} — від аналізу постанови до представництва в адміністративному суді.`,
  },
  "vlk-pro": {
    lead: (c) =>
